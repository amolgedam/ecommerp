...
class Excesses extends Admin_Controller 
{
	public function __construct()
	{
		...
		$this->load->model('model_excesses');
	...
	{
	    $data = $this->model_excesses->fecthAllData();
	   ...
	   // exit;
        ...
        else
        {
            ...
            foreach($data as $key => $value)
            {
                ...
                $buttons .= '&nbsp; <a href="'.base_url().'excesses/update/'.$value['id'].'" class="btn btn-sm btn-info"><i class="fa fa-edit"></i>Edit</a>';
                
                $buttons .= '&nbsp; <a href="'.base_url().'excesses/delete/'.$value['id'].'/inventoty_excesses" onclick="return confirm(\' you want to delete?\');" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i>Delete</a>';
	...
	{
		$this->render_template('admin_view/inventory/excesses/index', $this->data);
	}
	...
	public function create()
	{
	    ...
	    if ($this->form_validation->run() == TRUE) 
	    {
	        ...
	        $data = array(
        					...
        					'inventory_type' => "inventoty_excesses",
        	...
        	$created_id = $this->model_excesses->create($data);
        	...
        	if($created_id == true) {
    		    ...
    		    return redirect('excesses');
        	
        	}else {
        		
        		$this->session->set_flashdata('feedback','Unable to Saved Data');
				$this->session->set_flashdata('feedback_class','alert alert-danger');
				return redirect('excesses/create');
        	}
	    }
	    else
	    {
	        $orderNo = $this->model_excesses->lastrecord();
    		...
    		$this->render_template('admin_view/inventory/excesses/create', $this->data);   
	    }
	}
	...
	public function update()
	{
	    ...
	    if ($this->form_validation->run() == TRUE) 
	    {
	       ...
	       // exit;   
            ...
            $update = $this->model_excesses->update($data);
	        ...
	        if($update)
	        {
        		...
        		$this->session->set_flashdata('feedback','Unable to Saved Data');
				$this->session->set_flashdata('feedback_class','alert alert-danger');
				return redirect('excesses/update/'.$this->input->post('id'));
        	}
            
	    }
	    else
	    {
    	    $this->data['allData'] = $this->model_excesses->fecthAllDataByID($id);
    		...
    		$this->render_template('admin_view/inventory/excesses/update', $this->data);
	    }
	}
	...
	public function delete()
	{
        ...
        // echo $id; exit;
		$delete = $this->model_excesses->delete($id);	
