...
class Model_contraentry extends CI_Model
{
	...
	public function create($data = array())
	{
		if($data) {
			...
			$create = $this->db->insert('wo_contraentry', $data);
	...
	public function update($data = array())
	{
		if($data) {
			...
			$update = $this->db->update('wo_contraentry', $data);
	...
	{
		$this->db->where('id', $id);
		return $result=$this->db->delete('wo_contraentry');
	}
