            ...
            <div class="box-body">
                <div class="row">
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div align="left">
                        <h4 style="padding-left: 15px; font-weight: bold;">Sales Invoice Details</h4>
                        
                    </div>
                    <hr>
                    <div align="left">
                        <span style="font-weight: bold;">Total Sale:- 500</span>
                    </div>
                    <br>
            ...
            <div class="box-body">
                <div class="row">
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div align="left">
                        <h4 style="padding-left: 15px; font-weight: bold;">Purchase Invoice Details</h4>
