...
<form method="post" action="<?php echo base_url() ?>deliverymemo/create">
                ...
                <div class="row">
                  ...
                  <div class="col-md-4 col-sm-4 col-xs-12">
                    <div>
                      ...
                      <select name="sales_ac" class="form-control">
                  ...
                  <div class="col-md-4 col-sm-4 col-xs-12">
                    <div>
                      ...
                      <input type="text" name="no_product" required id="cpno" class="form-control" readonly>
                    </div>
                  </div>
                  <div class="col-md-4 col-sm-4 col-xs-12">
                    <div>
