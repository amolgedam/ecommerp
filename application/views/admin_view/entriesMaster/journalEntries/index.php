        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div style="float:right">
                  <a href="<?php echo base_url() ?>journalentry/create" class="btn btn-primary">
                    <i class="fa fa-plus-square"></i>&nbsp;Add Journal Entry
                  </a>
            </div>
            <br><br>
            <div class="box-body">
                ...
                <table class="table table-bordered table-striped" id="data">
                  ...
                  <tbody>
                    <!-- <tr>
                      ...
                      <td>Hold</td>
                      <td width="240px">
                        <a href="< ?php echo base_url() ?>journalentry/update" class="btn btn-sm btn-info">
        ...
        var base_url = '<?php echo base_url(); ?>';
            ...
            $('#data').DataTable({
                "ajax": {
                    ...
                    'serverSide':true,
                    "searching": true,
                    url : base_url + "journalentry/fetchAllData",
                    'order': []
                }, 
            });
    });
