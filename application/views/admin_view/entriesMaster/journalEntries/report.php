<?php
  ...
  $crledgerData = $this->model_ledger->fecthDataByID($allData['cr_ledgerid']);
  $drledgerData = $this->model_ledger->fecthDataByID($allData['dr_ledgerid']);
  
  // $paymentType = $this->model_paymentmaster->fecthDataByID($allData['paymenttype_id']);

  // echo "<pre>"; print_r($allData); //echo "<pre>"; print_r($ledgerData); 
  // exit;
                              ...
                              <td>
                                  <table border="1" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td>&nbsp;<?php echo "Journal Entry ".$allData['voucherno']; ?></td>
