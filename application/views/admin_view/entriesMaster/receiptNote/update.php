  ...
  <div class="content-wrapper">
    ...
    <?php echo form_open('receiptnote/update'); ?>
    <!-- Main content -->
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box" style="padding: 5px;">
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="col-md-4 col-sm-4 col-xs-12">
                      <div>
                        ...
                        <input type="hidden" name="id" value="<?php echo $allData['id']; ?>" class="form-control" class="form-control" readonly>
            ...
            <hr>
            <div align="right">
              <a href="<?php echo base_url() ?>receiptnote/delete/<?php echo $allData['id']; ?>" onclick="return confirm(\' you want to delete?\');" class="btn btn-danger">Delete</a>
