  ...
  <div class="content-wrapper">
    ...
    <?php echo form_open('contraentry/update'); ?>
        ...
        <div class="col-xs-12">
          <div class="box" style="padding: 5px;">
            <div class="box-body">
                            ...
                            <div>
                              ...
                              <select name="from_paymentType" class="form-control">
                                ...
                                <?php foreach($paymenttype as $rows): ?>
                                  <option value="<?php echo $rows->id; ?>" <?php echo $allData['from_paymenttypeid'] == $rows->id ? "selected" : ""; ?>><?php echo $rows->payment_name; ?></option>
                                <?php endforeach; ?>
                              </select>
                            </div>
                          </div>
                          <div class="col-md-4 col-sm-4 col-xs-12">
                            <div>
                              ...
                              <select name="to_paymentType" class="form-control">
                                <option value="0">---Select One---</option>
                                <?php foreach($paymenttype as $rows): ?>
                                  <option value="<?php echo $rows->id; ?>" <?php echo $allData['to_paymenttypeid'] == $rows->id ? "selected" : ""; ?>><?php echo $rows->payment_name; ?></option>
                                <?php endforeach; ?>
                              </select>
                            </div>
                          </div> 
             ...
             <hr>
              <div align="right">
                <a href="<?php echo base_url() ?>contraentry/delete/<?php echo $allData['id'] ?>" onclick="return confirm(\' you want to delete?\');" class="btn btn-danger">Delete</a>
