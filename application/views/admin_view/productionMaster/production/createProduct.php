<!--< ?php echo "<pre>";print_r($allData);exit; ?>-->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Production - New Product Creation
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <div class="box-body">
                <form method="post" action="<?php echo base_url('production/createProduct') ?>">
                <div class="row">
                    ...
                    <div>
                      ...
                      <select name="product_category" id="category" class="form-control">
                        ...
                        <?php foreach($category as $rows): ?>
                            <option value="<?php echo $rows->id; ?>" <?php echo $allData['p_category'] == $rows->id ? "selected" : ""; ?>><?php echo $rows->catgory_name; ?></option>
                        <?php endforeach; ?>
                      </select>
                    </div>
                  </div>
                    ...
                    <div>
                      ...
                      <select name="product_subcategory" id="sub_category" class="form-control">
                        ...
                        <?php foreach($subcategory as $rows): ?>
                            <option value="<?php echo $rows->id; ?>" <?php echo $allData['p_scate'] == $rows->id ? "selected" : ""; ?>><?php echo $rows->subcategory_name; ?></option>
                        <?php endforeach; ?>
                      </select>
                    </div>
                  </div>  
                  ...
                  <div class="col-md-4 col-sm-4 col-xs-12">
                            ...
                            <input type="hidden" name="unit" id="unitValue" class="form-control">
                              <select name="unitid" id="unit" class="form-control">
                                ...
                                <?php foreach($unit as $rows): ?>
                                    <option value="<?php echo $rows->id; ?>" <?php echo $skuData['unit_id'] == $rows->id ? "selected" : ""; ?>><?php echo $rows->unit; ?></option>
                                <?php endforeach; ?>
                              </select>
                        </div>
                        <!--<div class="col-md-2">-->
                   ...
                   <div class="col-md-4 col-sm-4 col-xs-12">
                    <div>
                      ...
                      <input id="txtQty" name="quantitypieces" value="<?php echo $allData['quantity']; ?>" type="hidden" class="form-control check">
                   ...
                   <div class="col-md-4 col-sm-4 col-xs-12">
                    <div>
                      ...
                      <input type="text" name="base_price" id="base_price" value="<?php echo $allData['pcost_unit']; ?>" class="form-control check">
                    </div>
                  </div>
                  <div class="col-md-4 col-sm-4 col-xs-12">
                    <div>
                  ...
                  <div class="col-md-4 col-sm-4 col-xs-12">
                    <div>
                      ...
                      <input type="text" name="pur_price" id="pur_price" value="<?php echo $allData['total_pcost']; ?>" class="form-control" readonly>
                    </div>
                  </div>
                  ...
                  <div class="col-md-4 col-sm-4 col-xs-12">
                   ...
                   <div class="col-md-4 col-sm-4 col-xs-12">
                    <div>
                      ...
                      <input type="text" name="wspp" id="wspp" value="<?php echo $allData['total_pcost']; ?>" class="form-control" readonly>
                    </div>
                  </div>
