            ...
            $.ajax({
                        ...
                        success: function(response){
                            ...
                            $.each(response, function(index, value) { 
                                ...
                                html += '<tr id="row_'+row_id+'">';
                                  html += '<th>';
                                    html += '<input type="hidden" name="attrid" id="attrid_'+row_id+'" value="'+value.id+'"  />'+value.color+'';
                                  html += '</th>';
                                  html += '<th>';
                                    html += ''+value.size+'';
                                  html += '</th>';
                                  ...
                                  html += '</th>';
                                  html += '<th>';
                                    html += '<input type="hidden" name="qtyData" id="qtyData_'+row_id+'" value="'+value.quantity+'"  />'+value.quantity+'';
                                  html += '</th>';
                                  html += '<th>';
                                    html += '<a href="javascript:void(0);" onclick="addQty('+row_id+')" class="btn btn-danger btn-sm remove">Remove</a>';
                                  html += '</th>';
