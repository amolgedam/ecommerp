      ...
      <div class="row">
        ...
        <?php echo form_open_multipart('opening_stockitem/createItemUploadFile'); ?>
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="hidden" name="order_id" id="order_id" value="<?php echo $productionid ?>" >

                        <input type="hidden" name="editAttrID" id="editAttrID"/>

                        <label>Selected Quantity</label>
                        <input type="text" name="orderQuantity" id="orderQuantity" value="<?php echo $productionQty; ?>" readonly class="form-control">
                        <input type="hidden" name="matchQty" id="matchQty" value="<?php echo $productionQty; ?>" readonly class="form-control">
               ...
               <!--  <div class="col-md-12">
                ...
                <div class="col-md-12">
                  <div align="right">
                    <a href="<?php echo base_url() ?>barcode/production/<?php echo $productionid; ?>/"  class="btn btn-danger"><< Generate Barcode</a>
                  </div>
                </div>
    ...
    $(document).ready(function(){
        ...
        $('#saveData').on('click', function(){
            ...
            // {
                ...
                {   
                    ...
                    $.ajax({
                        method: 'post',
                        url: base_url + 'production/uploadImagesData',
                        data: formData,
                        dataType: 'JSON',
                        contentType: false, 
                        processData: false,
        ...
        $('#editData').on('click', function(){
            ...
            {   
                ...
                // console.log("orderid "+orderid+" order_code "+order_code+" ordertype "+ordertype+" id "+id+" color "+color+" size "+" pattern "+style1+" style2 "+style2+" type "+type);
                ...
                $.ajax({
                    method: 'post',
                    url: base_url + 'opening_stockitem/uploadImagesDataUpdate',
                    data: formData,
                    dataType: 'JSON',
                    contentType: false, 
                    processData: false,
