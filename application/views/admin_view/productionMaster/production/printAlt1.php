 ...
 <?php 
    ...
    $salesInvoice = $this->model_salesinvoice->fecthAllDataByID($product['salesinvoice_id']);
    
    // echo "<pre>"; print_r($salesInvoice); exit();
    
    // $salesorder = $this->model_salesorder->fecthAllDatabyID($salesInvoice['salesorder_id']);
    
    
    $measurementData = $this->model_alternate->fecthAllMeasurementData($product['id']);
    $materialData = $this->model_alternate->fecthAllMaterialData($product['id']);
                                ...
                                <div class="col-md-6">
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $salesInvoice['inventory_no']; ?></td>
                                        </tr>
                                        <tr>
                                            <td><label>Quantity:- </label></td>
                                            <td>
                                                -
                                                <!--< ?php echo $salesQty['quantity']; ?>-->
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <table >
                                        <tr>
                                            ...
                                            <td><?php echo $product['alternate_no']; ?></td>
                                        </tr>
                                        <tr>
