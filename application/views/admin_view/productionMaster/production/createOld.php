  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        <form action="<?php echo base_url(); ?>production/create" method="post">
                ...
                <div class="row">
                    ...
                    <div>
                      ...
                      <select name="product_category" id="category" required class="form-control">
                        ...
                        <?php foreach($category as $rows): ?>
                            <option value="<?php echo $rows->id; ?>"><?php echo ucwords($rows->catgory_name); ?></option>
                        <?php endforeach; ?>
                      </select>
                    </div>
                  </div>
                    ...
                    <div>
                      ...
                      <select name="product_subcategory" required id="sub_category" class="form-control">
                        ...
                        <?php foreach($subcategory as $rows): ?>
                            <option value="<?php echo $rows->id; ?>"><?php echo ucwords($rows->subcategory_name); ?></option>
                        <?php endforeach; ?>
                      </select>
                    </div>
                  </div>
                          ...
                          <select name="sku" id="sku" class="form-control" required>
                            <option value="0">---Select One---</option>
                              <?php foreach($sku as $rows): ?>
                                <option value="<?php echo $rows['id']; ?>"><?php echo ucwords($rows['product_code']); ?></option>
                              <?php endforeach; ?>
                          </select>
                        </div>
                        <div class="col-md-2">
                  ...
                  <div class="col-md-4 col-sm-4 col-xs-12">
                    <div>
                      ...
                      <input type="date" name="jobsheet_date" id="jobsheet_date" value="<?php echo $date; ?>" required class="form-control">
                    </div>
                  </div>
                  ...
                  <div class="col-md-4 col-sm-4 col-xs-12">
                    <div>
                      ...
                      <input type="date" name="jobcompletion_date" id="jobcompletion_date" class="form-control">
                    </div>
                  </div>
                  ...
                  <div class="col-md-4 col-sm-4 col-xs-12">
                    <div>
                      ...
                      <input type="hidden" name="type" value="<?php echo $type; ?>">
                        <input type="hidden" name="orderjob" id="orderjob" value="<?php echo $orderjob; ?>">
                      
                      <select name="sales_order" id="sales_order" required class="form-control">
                        <option value="0">---Select One---</option>
                        <?php foreach($sales_order as $rows): ?>
                            <option value="<?php echo $rows->id; ?>" <?php echo $sorderid == $rows->id ? "selected" : ""; ?> ><?php echo ucwords($rows->order_no); ?></option>
                        <?php endforeach; ?>
                      </select>
                    </div>
                  </div>
