<!--< ?php echo "<pre>"; print_r($productCat); exit; ?>-->
<?php
  ...
  $topTotInwards = $topTotOutwards = $topTotBal = 0;
    ...
    foreach($productCat as $rows){
        ...
        foreach($skuData as $skurows){ 
            ...
            $barcodeInwardData = $this->model_barcode->fetchInwardItemQtyBySku($skurows->id);
            
            // echo "<pre>"; print_r($barcodeInwardData); exit();
            ...
            $barcodeData = $this->model_barcode->fetchSoldItemQtyBySku($skurows->id);
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <table border="1" width="100%">
                                                        <tr>
                                                            ...
                                                            <td style="width: 33%;">
                                                                <center><?php echo $outvalue != '' ? $outvalue : "0";?></center>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                <td>
                                                    <table border="1" width="100%">
                                                        <tr>
                                                            <td style="width: 33%;">
                                                                <center><?php echo $balQty != '0' ? $balQty." - ".$unit['unit'] : "-"; ?></center>
                                                            </td>
                                                            <td style="width: 33%;">
                                                                <center><?php echo $mrp != "" ? $mrp : "0";?></center>
                                                            </td>
