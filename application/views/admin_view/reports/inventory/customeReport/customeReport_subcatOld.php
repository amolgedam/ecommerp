        ...
        <div class="box">
          <div class="box-body">
            <div class="table-responsive">        
              ...
              <!-- ################################################################### -->
              <?php
                if(!empty($psubcatIds) OR !empty($pcatIds)  && empty($sku) && empty($brand))
                {
                    $finalInwards = $finalOutwards = $finalCl = 0;

                    $countsSbcat = count($psubcatIds);
                      
                    for ($i=0; $i < $countsSbcat; $i++) { 
                        
                        // echo "<pre>"; print_r($psubcatIds);
                        // echo "<pre>"; print_r($pcatIds);

                        $subCatData = $this->model_category->fecthSubCatDataByID($psubcatIds[$i]);

                        
                            $pcatData = $this->model_category->fecthCatDataByID1($subCatData['category_id']);
                      ...
                      ?>
                          ...
                          <?php
                            $skuData = $this->model_sku->fecthSkuByCatSubcatID($pcatData['id'], $subCatData['id']);
                          ?>
