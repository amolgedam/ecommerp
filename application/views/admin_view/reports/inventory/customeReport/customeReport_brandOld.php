        ...
        <div class="box">
          <div class="box-body">
            <div class="table-responsive">        
              ...
              <!-- ################################################################### -->
              <?php
                if(empty($pcatIds) && empty($psubcatIds) && !empty($skuIds) OR !empty($brandIds))
                {
                    $countBrand = count($brandIds);

                    for ($i=0; $i < $countBrand; $i++) { 
                        
                        $barcodeData = $this->model_barcode->fetchDataByBrandid($brandIds[$i]);
                    ...
                    <?php
                      if(empty($pcatIds) && empty($psubcatIds) && !empty($skuIds) OR !empty($brandIds))
                      {
                        ...
                        { 
                            ...
                            $barcodeData = $this->model_barcode->fetchDataByBrand1($brandIds[$i]);
