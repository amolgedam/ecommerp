      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box" style="padding: 5px">
              <div class="row">
                 <form method="post" action="<?php echo base_url('purchase_invoiceitem/updateItem') ?>">
                ...
                <div class="col-md-2 col-sm-2 col-xs-12">
                  <div>
                    ...
                    <div class="row">
                      ...
                      <!--    </div>-->
                      <?php $attr = array(); $attr = explode(', ', $color['attr_values']); ?>
                        <div class="col-md-12">
                        <select name="color" id="color" class="form-control">
                          <option value="0">---Select One---</option>
                          <?php foreach($attr as $rows): ?>
                            <option value="<?php echo $rows ?>"  <?php echo $allData['color'] == $rows ? "selected" : ""; ?>><?php echo $rows ?></option>
                          <?php endforeach; ?>
                        </select>
                ...
                <div class="col-md-2 col-sm-2 col-xs-6">
                  <div>
                    ...
                    <div class="row">
                      ...
                      <!--    </div>-->
                      <?php $attr = array(); $attr = explode(', ', $size['attr_values']); ?>
                       <div class="col-md-12">
                        <select name="size" id="size" class="form-control">
                          <option value="0">---Select One---</option>
                          <?php foreach($attr as $rows): ?>
                            <option value="<?php echo $rows ?>" <?php echo $allData['size'] == $rows ? "selected" : ""; ?> ><?php echo $rows ?></option>
                          <?php endforeach; ?>
                        </select>
                      </div>
                    </div>
                  ...
                  <div>
                    <label>Texture/Pattern</label>
                     <div class="row">
                      ...
                      <!--</div>-->
                      <?php $attr = array(); $attr = explode(', ', $pattern['attr_values']); ?>
                      <div class="col-md-12">
                        <select name="pattern" id="pattern" class="form-control">
                          <option value="0">---Select One---</option>
                          <?php foreach($attr as $rows): ?>
                            <option value="<?php echo $rows ?>"  <?php echo $allData['pattern'] == $rows ? "selected" : ""; ?>><?php echo $rows ?></option>
                          <?php endforeach; ?>
                        </select>
                      </div>
                    </div>
                ...
                <div class="col-md-2 col-sm-2 col-xs-6">
                  <div>
                    ...
                    <div class="row">
                      ...
                      <!--</div>-->
                      <?php $attr = array(); $attr = explode(', ', $style1['attr_values']); ?>
                      <div class="col-md-12">
                        <select name="style1" id="style1" class="form-control">
                          <option value="0">---Select One---</option>
                          <?php foreach($attr as $rows): ?>
                            <option value="<?php echo $rows ?>"  <?php echo $allData['style1'] == $rows ? "selected" : ""; ?> ><?php echo $rows ?></option>
                          <?php endforeach; ?>
                        </select>
                      </div>
                    </div>
                ...
                <div class="col-md-2 col-sm-2 col-xs-6">
                  <div>
                    ...
                    <div class="row">
                      ...
                      <!--</div>-->
                      <?php $attr = array(); $attr = explode(', ', $style2['attr_values']); ?>
                      <div class="col-md-12">
                        <select name="style2" id="style2" class="form-control">
                          <option value="0">---Select One---</option>
                          <?php foreach($attr as $rows): ?>
                            <option value="<?php echo $rows ?>" <?php echo $allData['style2'] == $rows ? "selected" : ""; ?> ><?php echo $rows ?></option>
                          <?php endforeach; ?>
                        </select>
                      </div>
                    </div>
                  ...
                  <div>
                    <label>Type</label>
                     <div class="row">
                      ...
                      <!--</div>-->
                      <?php $attr = array(); $attr = explode(', ', $type['attr_values']); ?>
                      <div class="col-md-12">
                        <select name="type" id="type" class="form-control">
                          <option value="0">---Select One---</option>
                          <?php foreach($attr as $rows): ?>
                            <option value="<?php echo $rows ?>" <?php echo $allData['type'] == $rows ? "selected" : ""; ?> ><?php echo $rows ?></option>
                          <?php endforeach; ?>
                        </select>
                      </div>
                    </div>
