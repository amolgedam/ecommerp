...
<?php
  $skuData = $this->model_sku->fecthSkuDataByID($allData['sku_id']);
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-body">
                ...
                <form method="post" action="<?php echo base_url('purchase_invoiceitem/update') ?>">
                <div class="row">
                            ...
                            <select name="sku" id="sku" class="form-control">
                              <option value="0">---Select One---</option>
                                <?php foreach($sku as $rows): ?>
                                    <option value="<?php echo $rows->id; ?>"  <?php echo $allData['sku_id'] == $rows->id ? "selected" : ""; ?> ><?php echo $rows->product_code; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                         <div class="col-md-2">
                  ...
                  <div class="col-md-4 col-sm-4 col-xs-12">
                    <div>
                      ...
                      <div class="row">
                        <div class="col-md-12">
                            <input type="hidden" name="unit" value="<?php echo $allData['unit_id']; ?>" id="unitValue" class="form-control">
                          <select name="unitid" id="unit" class="form-control">
                            <option value="0">---Select One---</option>
                            <?php foreach($unit as $rows): ?>
                                <!--<option value="< ?php echo $rows->id; ?>" < ?php echo $allData['unit_id'] == $rows->id ? "selected" : ""; ?> >< ?php echo $rows->unit_cat_name; ?></option>-->
                        ...
                        <div class="col-md-10">
                          <select name="hsn" id="hsnData" class="form-control">
                            ...
                            <?php foreach($hsn as $rows): ?>
                                <option value="<?php echo $rows->id; ?>" <?php echo $allData['hsn_id'] == $rows->id ? "selected" : ""; ?>  ><?php echo $rows->hsn_code; ?></option>
                            <?php endforeach; ?>
                          </select>
                        </div>
                        <div class="col-md-2">
                   ...
                   <div class="col-md-4 col-sm-4 col-xs-12">
                    <div>
                      ...
                      <input type="text" name="quality" id="quality" value="<?php echo $allData['quantity'] ?>" class="form-control check">
                      <input type="hidden" name="oldQuality" value="<?php echo $allData['quantity'] ?>" class="form-control check">
                    </div>
                  </div>
                   <div class="col-md-4 col-sm-4 col-xs-12">
                    <div>
                      ...
                      <input type="hidden" name="base_priceOld" value="<?php echo $allData['base_price'] ?>" class="form-control check">
                    </div>
                  </div>
                  <div class="col-md-4 col-sm-4 col-xs-12">
                    <div>
                      <label>GST</label>
                       <div class="row">
                        <div class="col-md-12">
                            <input type="hidden" name="gstOld" value="<?php echo $allData['gst_id'] ?>">
                          <select name="gst" id="gst" ng-model="gst" class="form-control">
                            <option value="10">---Select One---</option>
                            <?php foreach($gst as $rows): ?>
                                <option value="<?php echo $rows->id; ?>" <?php echo $allData['gst_id'] == $rows->id ? "selected" : ""; ?> ><?php echo $rows->gst_name; ?></option>
                            <?php endforeach; ?>
                          </select>
                        </div>
                        <!--<div class="col-md-2">-->
                  ...
                  <div class="col-md-4 col-sm-4 col-xs-12">
                    <div>
                      <label>SGST</label>
                      <input type="text" name="sgst" id="sgst" value="<?php echo $gstData['sgst'] ?>" class="form-control" class="form-control" readonly >
                  ...
                  <div class="col-md-4 col-sm-4 col-xs-12">
                    <div>
                      <label>CGST</label>
                      <input type="text" name="cgst" id="cgst" value="<?php echo $gstData['cgst'] ?>" class="form-control" readonly >
                  ...
                  <div class="col-md-4 col-sm-4 col-xs-12">
                    <div>
                      <label>IGST</label>
                      <input type="text" name="igst" id="igst" value="<?php echo $gstData['igst'] ?>"  class="form-control" readonly >
                  ...
                  <div class="col-md-4 col-sm-4 col-xs-12">
                    <div>
                      ...
                      <input type="text" name="pur_price" id="pur_price" value="<?php echo $allData['base_price'] ?>" class="form-control" readonly>
                    </div>
                  </div>
                  ...
                  <div class="col-md-4 col-sm-4 col-xs-12">
                   ...
                   <div class="col-md-4 col-sm-4 col-xs-12">
                    <div>
                      ...
                      <input type="text" name="wspp" id="wspp" value="<?php echo $allData['wsp_price'] ?>" class="form-control" readonly>
                      <input type="hidden" name="oldwspp" value="<?php echo $allData['wsp_price'] ?>" class="form-control" readonly>
                    </div>
                  </div>
                  ...
                  <div class="col-md-4 col-sm-4 col-xs-12">
                    <div>
                      <label>MRP</label>
                      <input type="text" name="mrp" id="mrp" value="<?php echo $allData['mrp_price'] ;?>"  class="form-control check" required>
                      <input type="hidden" name="mrpOld" id="mrp" value="<?php echo $allData['mrp_price'] ;?>"  class="form-control check" required>
                    </div>
                  </div>
                    ...
                    <div>
                      ...
                      <select name="discount_code" class="form-control">
                        ...
                        <?php foreach($discount as $rows): ?>
                            <option value="<?php echo $rows->id; ?>" <?php echo $allData['discount_id'] == $rows->id ? "selected" : ""; ?> ><?php echo $rows->discount; ?></option>
                        <?php endforeach; ?>
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="col-md-4 col-sm-4 col-xs-12">
                    <div>
                      ...
                      <input type="text" name="comm" value="<?php echo $allData['salesman_commision'] ?>" class="form-control">
                    </div>
                  </div>
              ...
              <hr>
              <div align="right">
                <a href="<?php echo base_url() ?>purchase_invoice" class="btn btn-danger" >Back</a>
