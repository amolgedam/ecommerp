        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-body">
                ...
                <form method="post" action="<?php echo base_url('purchase_item/update') ?>">
                <div class="row">
                    ...
                    <div>
                      ...
                      <select name="product_category" id="category" class="form-control">
                        ...
                        <?php foreach($category as $rows): ?>
                            <option value="<?php echo $rows->id; ?>" <?php echo $allData['pcategories_id'] == $rows->id ? "selected" : ""; ?> ><?php echo $rows->catgory_name; ?></option>
                        <?php endforeach; ?>
                      </select>
                    </div>
                  </div>
                    ...
                    <div>
                      ...
                      <select name="product_subcategory" id="sub_category" class="form-control">
                        ...
                        <?php foreach($subcategory as $rows): ?>
                            <option value="<?php echo $rows->id; ?>" <?php echo $allData['psubcat_id'] == $rows->id ? "selected" : ""; ?> ><?php echo $rows->subcategory_name; ?></option>
                        <?php endforeach; ?>
                      </select>
                    </div>
                  </div>  
                  ...
                  <div class="col-md-4 col-sm-4 col-xs-12">
                   ...
                   <div class="col-md-4 col-sm-4 col-xs-12">
                    <div>
                      ...
                      <input type="text" name="quality" id="quality" value="<?php echo $allData['quantity'] ?>" readonly class="form-control check">
                    </div>
                  </div>
                   <div class="col-md-4 col-sm-4 col-xs-12">
                    <div>
