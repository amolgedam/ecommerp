  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <!-- Small boxes (Stat box) -->
       <form action="<?php echo base_url() ?>shortage/update" method="post">
            ...
            <div class="box-body">
              ...
              <div class="row">
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                  <div>
                    <label>Shortages No</label>
                    <input type="hidden" name="id" value="<?php echo $allData['id']; ?>" class="form-control" readonly>
                    <input type="text" name="inventory_no" value="<?php echo $allData['inventory_no']; ?>" class="form-control" required readonly>
                  </div>
                </div>
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                  <div>
                    <label>Date</label>
                    <input type="date" name="date" class="form-control" value="<?php echo $allData['date']; ?>" required>
                  </div>
                </div>
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                  <div>
                    ...
                    <input type="text" name="total_invoice" id="invoice_value" value="<?php echo $allData['totinvoice_value']; ?>"  class="form-control" readonly>
                  </div>
                </div>             
            </div>
