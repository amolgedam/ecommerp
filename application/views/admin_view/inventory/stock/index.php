        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div style="float:right">
              <a href="<?php echo base_url() ?>opening_stock/create" class="btn btn-sm btn-info"><i class="fa fa-plus"></i> Add Stock</a>
            </div>
            <br><br>
            <div class="box-body">
              <div class="table-responsive">
                <table class="table table-bordered table-striped" id="data">
                  ...
                  <tbody>
                    ...
                    <!--  <td>1635.11</td>-->
                    <!--  <td width="240px">-->
                    <!--    <a href="< ?php echo base_url() ?>opening_stock/update" class="btn btn-sm btn-info">-->
        ...
        var base_url = '<?php echo base_url(); ?>';
            ...
            $('#data').DataTable({
                "ajax": {
                    ...
                    'serverSide':true,
                    "searching": true,
                    url : base_url + "opening_stock/fetchAllData",
                    'order': []
                },
