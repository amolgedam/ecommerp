    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <!--<form method="post" action="< ?php echo base_url('opening_stockitem/createItem') ?>">-->
...
<!--                         <input type="text" name="orderQuantity" id="orderQuantity" value="< ?php echo $quantity; ?>" readonly class="form-control">
                ...
                <div class="col-md-2 col-sm-2 col-xs-6">
                  <div>
                    ...
                    <input type="text" name="quality" id="itemQuantity" required class="form-control">
...
<!-- <input type="text" name="quality" id="itemQuantity" required class="form-control">
 ...
 -->
                ...
                <!-- <div class="col-md-2 col-sm-2 col-xs-6">
                  <div>
                    <label>Images show on website</label>
                     <div class="row">
                      <div class="col-md-12">
                ...
                <div class="col-md-12">
                  <div align="right">
                    <a href="<?php echo base_url() ?>opening_stock/update/<?php echo $order_id; ?>"  class="btn btn-danger"><< Back</a>
                  </div>
                </div>
...
<script type="text/javascript">
  ...
  $('#add').on('click', function(){
    ...
    // console.log(qty);console.log(newqty);
  ...
  {     
    ...
    // var newqty = $('#itemQuantity').val();
    var matchQty = parseFloat($('#matchQty').val());
        ...
        $('#saveData').on('click', function(){
            ...
            // {
                ...
                {   
                    ...
                    $.ajax({
                        method: 'post',
                        url: base_url + 'opening_stockitem/uploadImagesData',
                        data: formData,
                        dataType: 'JSON',
                        contentType: false, 
                        processData: false,
