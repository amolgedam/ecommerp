          ...
          <div class="box">
            <div class="box-body">
              ...
              <div class="row">
                 ...
                 <div class="col-md-4 col-sm-4 col-xs-12">
                  <div>
                    ...
                    <input type="text" name="exchange_no" value="<?php echo $orderNo; ?>" class="form-control" readonly>
                   </div>
                </div> -->
                 <div class="col-md-4 col-sm-4 col-xs-12">
                  <div>
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                        <div>
                          ...
                          <input type="text" name="total_amt" class="form-control" id="amt" value="0" readonly>
                        </div>
                      </div>
                <div class="col-md-4 col-sm-4 col-xs-12">
                  <div>
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                  <div>
                    ...
                    <input type="text" name="total_invoice" id="invoice_value" class="form-control checkAmt" readonly="" value="0">
                  </div>
                </div>             
            </div>
              <hr>
              <div align="right">
                ...
                <input type="submit" name="payment" value="Make Payment" id="makePayment" class="btn btn-success">
              </div>
    ...
    $.ajax({
            ...
            success:function(response){
              ...
              else
              {
                ...
                var comm = (response.grossprice * response.salesmancomm /100);
                // console.log(comm);
                comm = (comm).toFixed(3);
                  ...
                  var html = '';
                    ...
                    html += '<tr id="row_'+row_id+'">'
                      ...
                      html += '<td>';
                        html += '<input type="hidden" name="barcodelistid[]" value="'+response.pnoid+'" readonly>';
                      ...
                      html += '<td>';
                        html += '<input type="hidden" name="commExchange[]" id="commexchange_'+row_id+'" class="salescomm" value="'+comm+'">';
                        html += '<input type="text" name="salesmancommlist[]" id="salesmancommlist_'+row_id+'" readonly value="'+response.salesmancomm+'" >';
                      html += '</td>';
                                    ...
                                    success:function(response){
                                        ...
                                        else
                                        {
                                            ...
                                            html += '<tr id="row_'+row_id+'">';
                                                ...
                                                html += '<td>';
                                                    html += '<input type="text" name="oldbaseprice[]" value="'+response[0].mrp+'" onchange="mrpChange('+row_id+')" id="baseprice_'+row_id+'" class="bpclass">';
                                                html += '</td>';
                                                
                                                html += '<td>';
                                                    html += '<input type="hidden" name="disvalueNew[]" id="disvalue_'+row_id+'" class="discountClass">';
                                                    
                                                    html += '<select name="discountIDNew[]" id="discoount_'+row_id+'" onchange="getDiscount('+row_id+')">';
                                                            html += '<option value="0">---Select One---</option>';
                                                ...
                                                html += '<td>';
                                                    ...
                                                    html += '<input type="hidden" name="basepriceNew[]" id="hiddenbaseprice_'+row_id+'" value="'+response[0].mrp+'" class="bpclass" readonly>';
                                                    html += '<input type="hidden" name="hiddenbaseprice1[]" id="hiddenbaseprice1_'+row_id+'" readonly>';
