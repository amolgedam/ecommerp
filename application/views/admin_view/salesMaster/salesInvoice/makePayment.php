    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <div class="box-body">
              <?php echo form_open('sales_invoice/makePayment'); ?>
                <div class="row">
                  
                  <div class="col-md-2 col-sm-4 col-xs-12">
                    <div>
                      <label>Estimated Total</label>
                      <input type="text" name="totvalue" id="estimated" class="form-control" value="<?php echo $allData['total_invoice']; ?>" readonly>
...
<script>
    ...
    $('#paid').on('keyup', function(){
        ...
        var estimated = parseFloat($('#estimated').val());
