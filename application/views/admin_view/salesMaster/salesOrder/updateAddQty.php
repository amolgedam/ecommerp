<!-- < ?php echo "<pre>"; print_r($conversionData); exit; ?> -->
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <div class="box-body">
              <?php echo form_open('sales_order/addQtyUpdate'); ?>
                <div class="row">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-body">
              ...
              <?php echo form_open('sales_order/updateOrderByBarcode'); ?>
                ...
                <div class="row">
                    ...
                    <div class="table-responsive">
                        ...
                        <tbody id='consumptionData'>
                            <?php
                                $no = 1;
                                foreach ($conversionData as $rows) {
                            ?>
                            ...
                            ?>
                              ...
                              <tr id="row_<?php echo $no; ?>">
                                  <td>
                                    <input type="text" name="pno[]" value="<?php echo $rows['pno']; ?>" id="pno_<?php echo $no; ?>" required readonly>
                                  </td>
                                  <td>
                                    <input type="text" name="quantity[]" onchange="getConversionData(<?php echo $rows['quantity'] ?>)" id="quantity_<?php echo $no; ?>" class="countQuantity" value="1" readonly>
                                  </td>
                                  <td>&nbsp;</td>
                                  <td>&nbsp;</td>
                                  <td>
                                    <input type="text" name="baseprice[]" value="<?php echo $rows['baseprice'] ?>" id="baseprice_<?php echo $no; ?>" class="bpclass">
                                  </td>
                                  <td>
                                    <input type="text" name="grossprice[]" id="grossprice_<?php echo $no; ?>" value="<?php echo $rows['grossprice'] ?>" readonly class="gpClass">
                                  </td>
                                  <td>
                                    <input type="text" name="gst[]" id="gst_<?php echo $no ?>" value="<?php echo $gstData['gst_name'] ?>" > 
                                  </td>
                                  <td>
                                    <input type="text" name="gstamt[]" id="gstamt_<?php echo $no ?>" class="txClass" value="<?php echo $rows['gstamt'] ?>">
                                  </td>
                                  <td>
                                    <input type="text" name="salesmancomm[]" id="salesmancomm_<?php echo $no ?>" value="<?php echo $rows['salesmancomm'] ?>">
                                  </td>
                                  <td>
                                    <input type="text" name="finalprice[]" id="finalprice_<?php echo $no; ?>" class="finalClass" value="<?php echo $rows['finalprice'] ?>">
                                  </td>
                                  <td>
                                    <input type="text" name="sku[]" value="<?php echo $rows['sku'] ?>" id="sku_<?php echo $no; ?>" readonly>
                                  </td>
                                  <td>
                      ...
                      $.ajax({
                          ...
                          success:function(discountResponse){
                            ...
                            $.ajax({  
                              ...
                              url: base_url + 'sales_order/fetchDataByBarcodeId',
                              type: 'post',
                              dataType: 'json',
                              ...
                              // console.log(barcode_code);
                                  ...
                                  else
                                  {
                                      ...
                                      html += '<tr id="row_'+row_id+'">';
                                          ...
                                          html += '<td>';
                                              html += '<input type="text" name="gstamt[]" id="gstamt_'+row_id+'" readonly class="txClass" value="0" onblur="'+loadCount()+'">';
                                          html += '</td>';
                                          ...
                                          html += '<td>';
                                              html += '<input type="text" name="finalprice[]" id="finalprice_'+row_id+'" class="finalClass" readonly value="0">';
                                          html += '</td>';
