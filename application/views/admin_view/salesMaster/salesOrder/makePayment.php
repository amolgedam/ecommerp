    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <div class="box-body">
              <?php echo form_open('sales_order/makepayment'); ?>
                <div class="row">
                  ...
                  <div class="col-md-2 col-sm-4 col-xs-12">
                    <div>
                      ...
                      <input type="text" name="estimated" id="estimated" class="form-control" value="<?php echo $allData['estimated_total']; ?>" readonly>
                    ...
                    <div class="col-md-2 col-sm-4 col-xs-12">
                     ...
                     <div class="col-md-2 col-sm-4 col-xs-12">
                        <div>
                          ...
                          <input type="date" name="entrydate" value="<?php echo $allData['order_date']; ?>" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-2 col-sm-4 col-xs-12">
                        <div>
...
<script>
    ...
    $('#paid').on('keyup', function(){
        ...
        // else
        // {
            $('#remainingpaid').val(estimated - paid);
        // }
