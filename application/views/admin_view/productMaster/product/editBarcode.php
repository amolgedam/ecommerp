<?php 
    ...
    if($allData['purchase_type'] == 'pinvoice')
    {
        $orderData = $this->model_purchaseitem->fecthAllDataByID($allData['product_id']);
        
        $wsp = $orderData['wsp'];
        $location = $orderData['location_id'];
    }
    else if($allData['purchase_type'] == 'opening_stock')
    {
        $orderData = $this->model_openingitem->fecthAllDataByID($allData['product_id']);
        
        $wsp = $orderData['wsp'];
        $location = $orderData['location'];
    }
    else if($allData['purchase_type'] == 'production')
    {
        $orderData = $this->model_openingitem->fecthAllDataByID($allData['product_id']);
    ...
    $skuData = $this->model_sku->fecthSkuDataByID($allData['sku_code']);
    
    $gstData = $this->model_gst->fetchAllDataByID($allData['gst_id']);
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <div class="box-body">
                <form method="post" action="<?php echo base_url('barcode/updatedata') ?>">
                <div class="row">
                  ...
                  <input type="hidden" readonly name="id" value="<?php echo $allData['id']; ?>" class="form-control check">
                  
                  <input type="hidden" readonly name="url" value="<?php echo $_SERVER['HTTP_REFERER']; ?>" class="form-control">
                            ...
                            <select name="sku" id="sku" class="form-control">
                              <option value="0">---Select One---</option>
                                <?php foreach($sku as $rows): ?>
                                    <option value="<?php echo $rows['id']; ?>" <?php echo $skuData['id'] == $rows['id'] ? "selected" : ""; ?> ><?php echo $rows['product_code']; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                         <div class="col-md-2">
                  ...
                  <div class="col-md-4 col-sm-4 col-xs-12">
                   ...
                   <div class="col-md-4 col-sm-4 col-xs-12">
                    <div>
                      ...
                      <input type="text" name="quality" id="quality" value="<?php echo $allData['qty']; ?>" class="form-control check">
                   ...
                   <div class="col-md-4 col-sm-4 col-xs-12">
                    <div>
                      ...
                      <input type="text" name="base_price" value="<?php echo $allData['basic_rate']; ?>" id="base_price" class="form-control check">
                    </div>
                  </div>
                  <div class="col-md-4 col-sm-4 col-xs-12">
                    <div>
                  ...
                  <div class="col-md-4 col-sm-4 col-xs-12">
                    <div>
                      ...
                      <input type="text" name="pur_price" value="<?php echo $allData['basic_rate']; ?>" id="pur_price" class="form-control" readonly>
                    </div>
                  </div>
                  ...
                  <div class="col-md-4 col-sm-4 col-xs-12">
                    <div>
                      <label>WSP (%)</label>
                      <input type="text" name="wsp" value="<?php echo $wsp; ?>" id="wsp" class="form-control">
                    </div>
                  </div>
                   <div class="col-md-4 col-sm-4 col-xs-12">
                    <div>
                      <label>WSP Net Price Unit</label>
                      <input type="text" name="wspp" value="<?php echo $allData['wsp']; ?>" id="wspp" class="form-control" readonly>
                    </div>
                  </div>
                    ...
                    <div>
                      ...
                      <select name="location" class="form-control">
                        ...
                        <?php foreach($locations as $rows): ?>
                            <option value="<?php echo $rows->id; ?>" <?php echo $location == $rows->id ? "selected" : ""; ?> ><?php echo $rows->location_name; ?></option>
                        <?php endforeach; ?>
                      </select>
                    </div>
                  </div>
                    ...
                    <div>
                      ...
                      <select name="discount_code" class="form-control">
                        ...
                        <?php foreach($discount as $rows): ?>
                            <option value="<?php echo $rows->id; ?>" <?php echo $allData['discountcode'] == $rows->id ? "selected" : ""; ?>  ><?php echo $rows->discount; ?></option>
                        <?php endforeach; ?>
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="col-md-4 col-sm-4 col-xs-12">
                    <div>
                      ...
                      <input type="text" name="comm" value="<?php echo $allData['salesmancomm']; ?>" class="form-control">
                    </div>
                  </div>
